            ...
            <div className="col-sm-11">
              <div className="social-icons contactinfo pull-right">
                <ul className="nav navbar-nav">
                  <li><a href="https://www.facebook.com/profile.php?id=1709940267"><i className="fa fa-facebook"></i></a></li>
                  <li><a href="https://www.linkedin.com/in/daniel-peretz93/"><i className="fa fa-linkedin"></i></a></li>
                  <li><a href="mailto:danielosh993@gmail.com"><i className="fa fa-envelope"></i> danielosh993@gmail.com</a></li>
                </ul>
              </div>
            </div>
